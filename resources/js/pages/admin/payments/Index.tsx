...
export default function Index({ payments, filters }: any) {
    ...
    const handleDelete = (id: number) => {
        if (confirm('Are you sure you want to delete this payment record? This will revert associated installments to unpaid.')) {
    ...
    return (
        <AppEliteCoachLayout title="Revenue Management">
            ...
            <div className="w-full px-6 lg:px-12 py-10 flex-1 flex flex-col">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
                    <div>
                        ...
                        <p className="text-xs font-bold text-gray-400 uppercase tracking-widest mt-1">Audit and manage institutional revenue streams</p>
                    </div>
                    ...
                    <form onSubmit={handleSearch} className="flex flex-1 items-center gap-2 w-full">
                        <div className="relative flex-1 group">
                            ...
                            <input 
                                ...
                                placeholder="Search by student, receipt, or ID..."
                ...
                <div className="bg-white rounded-[2rem] border border-gray-100 shadow-sm overflow-hidden flex-1 flex flex-col">
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead>
                                <tr className="border-b border-gray-50 bg-gray-50/30">
                                    <th className="px-8 py-5 text-[11px] font-extrabold text-gray-400 uppercase tracking-wider">Transaction Identity</th>
                                    <th className="px-6 py-5 text-[11px] font-extrabold text-gray-400 uppercase tracking-wider">Student Payer</th>
                                    <th className="px-6 py-5 text-[11px] font-extrabold text-gray-400 uppercase tracking-wider">Date & Method</th>
                                    <th className="px-6 py-5 text-[11px] font-extrabold text-gray-400 uppercase tracking-wider text-center">Settlement</th>
                                    ...
                                    <tr key={p.id} className="group hover:bg-gray-50/50 transition-colors">
                                        <td className="px-8 py-5">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-xl bg-slate-50 border border-gray-100 flex items-center justify-center text-slate-400 group-hover:text-emerald-600 group-hover:border-emerald-100 transition-all">
                                                    <Receipt size={18} />
                                                </div>
                                                <div>
                                                    <div className="font-mono text-sm font-bold text-slate-900 tracking-tight">
                                                        {p.receipt_number || 'TRX-REF-PENDING'}
                                                    </div>
                                                    <div className="text-[10px] font-extrabold text-gray-400 uppercase tracking-wider mt-0.5">Reference Identity</div>
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-5">
                                            <div className="flex flex-col">
                                                ...
                                                <div className="text-[10px] font-bold text-gray-400 uppercase tracking-tight flex items-center gap-1 mt-0.5">
                                                    <ArrowRight size={10} /> {p.enrollment?.batch?.name}
                                                </div>
                                            </div>
                                        </td>
                                        <td className="px-6 py-5">
                                        ...
                                        <td className="px-6 py-5">
                                            <div className="flex flex-col items-center">
                                                ...
                                                <span className="text-[10px] font-extrabold text-gray-400 uppercase mt-0.5 tracking-tight">Amount Settled</span>
                                            </div>
                                        </td>
                                        <td className="px-6 py-5">
                                            <div className="flex justify-center">
                                                <div className={`flex items-center gap-1.5 px-3 py-1 rounded-full border text-[10px] font-extrabold uppercase tracking-widest ${getStatusColor(p.status)}`}>
                                        ...
                                        <td colSpan={6} className="px-8 py-20 text-center">
                                            <div className="flex flex-col items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-500 mt-1">Institutional revenue ledger is currently empty.</p>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div className="px-8 py-6 border-t border-gray-50 bg-gray-50/30 mt-auto flex flex-col sm:flex-row items-center justify-between gap-4">
                        <div className="text-xs font-bold text-gray-400 uppercase tracking-widest">
                            Showing {payments.from}-{payments.to} of {payments.total} Transactions
                        </div>
