...
export default function Index({ courses, filters }: any) {
    ...
    return (<><Head title="My Courses" /><div className="flex h-full flex-1 flex-col gap-4 p-6">
        <div className="flex items-center justify-between"><h1 className="text-2xl font-bold">My Courses</h1><Button onClick={() => router.visit('/instructor/courses/create')}>Create Course</Button></div>
